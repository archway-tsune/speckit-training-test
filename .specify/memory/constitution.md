...
Modified principles: 
  - NEW: テンプレート駆動開発
  - NEW: ドメイン分離
  - NEW: テスト駆動開発（TDD）必須（非交渉）
  - NEW: 共通UIコンポーネントの利用
  - NEW: 実装ワークフロー
Added sections:
  - 技術仕様（技術スタック、認証・認可、品質基準）
  - 開発規約（命名規約、テスト配置規約、開発ワークフロー）
  - 統制（言語指定を含む）
Templates requiring updates: 
  ✅ constitution.md created
  ⚠ Other templates require consistency validation (pending)
...
**すべての生成ドキュメント（仕様書・計画書・タスク・チェックリスト等）は見出し・本文ともに日本語で記述する**
